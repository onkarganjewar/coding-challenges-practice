...
/* suppose we have 10->20->30->40->50 kind of linked list
 * now if we want to insert element at 3rd position that is after 20
 * then exit the loop at 20 viz., i=0 and i=1 iteration
 * now when pos is 3 then we have to iterate pos-2 times to get only 2 iterations
 */
...
/*at this point we have current as 20
 * now new node is 90
 * so 10->20->30->40->50 becomes
 *    10->20->90->30->40->50
 *    that is 20.next = newnode
 *    and newnode.next = old20.next
 *
 */
								...
								//third call as 30
{
	...
	reverse_rec(current.next); //first iteration current.next = 20
								...
								//30 pops out of the stack and 20 comes above
								//now 20 pops out of the stack and 10 comes up
	...
	current.next = null;	//20.next = null so 10-->20  30-->20 (first link broken)
